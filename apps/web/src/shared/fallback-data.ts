...
export const fallbackNoc: NocSummary = {
  healthScore: 94,
  activeAlerts: { critical: 1, major: 3, minor: 8 },
  sites: { total: 18, degraded: 2, down: 0 },
  circuits: { total: 42, degraded: 4, down: 1 },
  ipam: { publicIpv4Utilization: 71, prefixesNearExhaustion: 3, undocumentedIps: 12 }
};
...
export const fallbackMaintenanceWindows: MaintenanceWindow[] = [
  {
    id: "mw-aqp-provider",
    objectType: "circuit",
    objectId: "ckt-lim-aqp-10g",
    title: "Revision proveedor Andean Fiber",
    status: "scheduled",
    startsAt: "2026-07-05T02:00:00.000Z",
    endsAt: "2026-07-05T04:00:00.000Z"
  }
];

export const fallbackSites: Site[] = [
  { id: "site-lim-core", code: "LIM-CORE", name: "POP Lima Centro", type: "pop", status: "healthy", devices: 42, circuits: 12, prefixes: 18, incidents: 0 },
  { id: "site-aqp-pop", code: "AQP-POP", name: "POP Arequipa", type: "pop", status: "degraded", devices: 18, circuits: 5, prefixes: 7, incidents: 2 },
  { id: "site-tru-nodo", code: "TRU-NODO", name: "Nodo Trujillo Norte", type: "node", status: "healthy", devices: 11, circuits: 3, prefixes: 5, incidents: 0 },
  { id: "site-la-joya", code: "LA-JOYA", name: "Hub La Joya", type: "hub", status: "healthy", devices: 0, circuits: 2, prefixes: 0, incidents: 0 },
  { id: "site-majes", code: "MAJES", name: "Hub Majes", type: "hub", status: "healthy", devices: 0, circuits: 4, prefixes: 0, incidents: 0 },
  { id: "site-santa-rita", code: "SANTA-RITA", name: "Sede Santa Rita", type: "node", status: "healthy", devices: 0, circuits: 1, prefixes: 0, incidents: 0 },
  { id: "site-corire", code: "CORIRE", name: "Sede Corire", type: "node", status: "healthy", devices: 0, circuits: 2, prefixes: 0, incidents: 0 },
  { id: "site-aplao", code: "APLAO", name: "Sede Aplao", type: "node", status: "healthy", devices: 0, circuits: 2, prefixes: 0, incidents: 0 },
  { id: "site-escalerillas", code: "ESCALERILLAS", name: "Sede Escalerillas", type: "node", status: "degraded", devices: 0, circuits: 1, prefixes: 0, incidents: 0 },
  { id: "site-quiscay", code: "QUISCAY", name: "Sede Quiscay", type: "node", status: "degraded", devices: 0, circuits: 1, prefixes: 0, incidents: 0 }
];

export const fallbackSiteMap: SiteMap = {
  nodes: [
    { id: "site-aqp-pop", code: "AQP-POP", name: "POP Arequipa", type: "provider_hub", status: "degraded", latitude: -16.409047, longitude: -71.537451, x: 120, y: 210 },
    { id: "site-la-joya", code: "LA-JOYA", name: "Hub La Joya", type: "hub", status: "healthy", latitude: -16.423, longitude: -71.818, x: 255, y: 245 },
    { id: "site-majes", code: "MAJES", name: "Hub Majes", type: "hub", status: "healthy", latitude: -16.35, longitude: -72.19, x: 430, y: 250 },
    { id: "site-santa-rita", code: "SANTA-RITA", name: "Sede Santa Rita", type: "access_site", status: "healthy", latitude: -16.49, longitude: -72.1, x: 500, y: 365 },
    { id: "site-corire", code: "CORIRE", name: "Sede Corire", type: "access_site", status: "healthy", latitude: -16.22, longitude: -72.47, x: 610, y: 185 },
    { id: "site-aplao", code: "APLAO", name: "Sede Aplao", type: "access_site", status: "healthy", latitude: -16.08, longitude: -72.49, x: 630, y: 320 },
    { id: "site-escalerillas", code: "ESCALERILLAS", name: "Sede Escalerillas", type: "access_site", status: "planned", latitude: -16.18, longitude: -72.57, x: 760, y: 145 },
...
export const fallbackProviders: Provider[] = [
  { id: "prov-andean-fiber", code: "ANDEAN", name: "Andean Fiber", type: "transport", status: "active", nocEmail: "noc@andeanfiber.example", activeCircuits: 9, availability30d: 99.71, mttrHours30d: 3.4 },
  { id: "prov-pacific-transit", code: "PACIFIC", name: "Pacific Transit", type: "internet_transit", status: "active", nocEmail: "noc@pacifictransit.example", activeCircuits: 4, availability30d: 99.96, mttrHours30d: 1.1 }
  ];

  export const fallbackProviderContracts: ProviderContract[] = [
    { id: "ctr-andean-transport-2026", providerCode: "ANDEAN", code: "AF-TRANS-2026", name: "Transporte regional sur/norte", status: "active", startDate: null, endDate: null, currency: "USD", monthlyCost: 8200, slaTarget: 99.7 },
    { id: "ctr-pacific-transit-2026", providerCode: "PACIFIC", code: "PT-IPT-2026", name: "Transito IP 20G Lima", status: "active", startDate: null, endDate: null, currency: "USD", monthlyCost: 14500, slaTarget: 99.9 }
  ];
  
  export const fallbackPrefixes: Prefix[] = [
  { id: "pfx-public-lim", prefix: "190.0.2.0/24", role: "public_customers", status: "active", siteCode: "LIM-CORE", vrf: "global", utilization: 86, source: "LACNIC" },
  { id: "pfx-mgmt-core", prefix: "10.10.0.0/20", role: "management", status: "active", siteCode: "LIM-CORE", vrf: "mgmt", utilization: 48, source: "internal" },
  { id: "pfx-aqp-access", prefix: "100.64.20.0/22", role: "cgnat_access", status: "active", siteCode: "AQP-POP", vrf: "access", utilization: 73, source: "internal" }
];
...
export const fallbackCircuits: Circuit[] = [
  { id: "ckt-lim-aqp-10g", code: "TR-LIM-ARE-10G", name: "Transporte Lima <> Arequipa", providerCode: "ANDEAN", providerName: "Andean Fiber", contractCode: "AF-TRANS-2026", status: "down", capacityMbps: 10000, aSite: "LIM-CORE", zSite: "AQP-POP", slaTarget: 99.7, endpointCount: 2, linkedInterfaces: 2 },
  { id: "ckt-lim-tru-2g", code: "TR-LIM-TRU-2G", name: "Transporte Lima <> Trujillo", providerCode: "ANDEAN", providerName: "Andean Fiber", contractCode: "AF-TRANS-2026", status: "active", capacityMbps: 2000, aSite: "LIM-CORE", zSite: "TRU-NODO", slaTarget: 99.5, endpointCount: 2, linkedInterfaces: 0 },
  { id: "ckt-transit-pacific", code: "IPT-PACIFIC-20G", name: "Transito IP principal", providerCode: "PACIFIC", providerName: "Pacific Transit", contractCode: "PT-IPT-2026", status: "active", capacityMbps: 20000, aSite: "LIM-CORE", zSite: "UPSTREAM", slaTarget: 99.9, endpointCount: 1, linkedInterfaces: 0 }
];

export const fallbackDevices: Device[] = [
  { id: "dev-pe-lima-01", name: "PE-LIMA-01", role: "core_router", siteCode: "LIM-CORE", status: "healthy", managementIp: "190.0.2.2", interfaces: 64, lastBackupAt: "2026-07-04T09:20:00.000Z" },
  { id: "dev-pe-aqp-01", name: "PE-AQP-01", role: "edge_router", siteCode: "AQP-POP", status: "degraded", managementIp: "190.0.2.18", interfaces: 48, lastBackupAt: "2026-07-03T22:12:00.000Z" },
  { id: "dev-olt-lim-03", name: "OLT-LIM-03", role: "olt", siteCode: "LIM-CORE", status: "healthy", managementIp: "10.10.12.3", interfaces: 16, lastBackupAt: "2026-07-04T08:01:00.000Z" }
];
...
export const fallbackAudit: AuditEvent[] = [
  {
    ...
    at: "2026-07-04T14:15:00.000Z"
  },
  {
    id: "aud-002",
    action: "circuit.updated",
    objectType: "circuit",
    objectLabel: "TR-LIM-ARE-10G",
    actor: "noc",
    reason: "Proveedor reporta degradacion",
    at: "2026-07-04T13:48:00.000Z"
  }
];

export const fallbackDocuments: TechnicalDocument[] = [
  {
...
export const fallbackEvidence: EvidenceFile[] = [
  {
    id: "ev-af-contract",
    objectType: "provider",
...
export const fallbackBackups: ConfigBackup[] = [
  {
    id: "bkp-pe-lima-01",
    device: "PE-LIMA-01",
    siteCode: "LIM-CORE",
...
export const fallbackBackupSummary: BackupSummary = {
  totalDevices: 3,
  devicesWithBackup: 2,
  staleBackups: 0
};

export const fallbackChanges: ChangeRequest[] = [
  {
    id: "chg-migration-lim-aqp",
    title: "Migracion transporte Lima-Arequipa",
    description: "Mover trafico a ruta alterna y validar reconvergencia.",
    status: "submitted",
    riskLevel: "high",
    plannedStart: "2026-07-05T02:00:00.000Z",
    plannedEnd: "2026-07-05T04:00:00.000Z",
    requestedBy: "Administrador ISP Ops",
    approvedBy: null,
    approvedAt: null,
    impactCount: 1
  }
...
export const fallbackRackViews: RackView[] = [
  {
    id: "rack-aqp-01",
    siteCode: "AQP-POP",
    code: "RACK-AQP-01",
...
export const fallbackPowerFeeds: PowerFeed[] = [
...
export const fallbackPowerAssets: PowerAsset[] = [
...
export const fallbackProviderCapacities: ProviderCapacity[] = [
...
export const fallbackFiberSpans: FiberSpan[] = [
...
export const fallbackFiberStrands: FiberStrand[] = [
...
export const fallbackTransceivers: Transceiver[] = [
...
export const fallbackPatchcords: Patchcord[] = [
...
export const fallbackDatacenterAssets: DatacenterAsset[] = [
